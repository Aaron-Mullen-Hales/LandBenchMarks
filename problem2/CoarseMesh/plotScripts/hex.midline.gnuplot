...
plot \
    "midLineDeformed.txt" u (1e3*$1):(1e3*$3) every 9::0 w lp pt 6 ps 1 lc "blue" t "{/Symbol \D}x = 1.26 mm", \
...
set size ratio 1
plot \
    "midLineDeformed.txt" u (1e3*$1):(1e3*$3) w lp pt 6 ps 1 lc "blue" t "{/Symbol \D}x = 1.26 mm", \
